...
export default function Contact() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    // Limpar status de erro quando usuário começar a digitar
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    <option value="" className="text-gray-700">Selecione um serviço</option>
                    <option value="poda" className="text-gray-900">🌳 Poda e Corte de Árvores</option>
                    <option value="jardinagem" className="text-gray-900">🌱 Jardinagem Profissional</option>
                    <option value="limpeza" className="text-gray-900">🧹 Limpeza Pós-Obra</option>
                    <option value="outros" className="text-gray-900">📋 Outros Serviços</option>
                  </select>
